    ...
    const register = async (req, res) => {
        ...
        try {
            ...
            if (user) {
                ...
                // Send mail to user
            sendMailToUser(email,name,user._id,token);
    ...
    function sendMailToUser(userEmail,userName,userId,token){
        sendingMail({
            ...
            html: `
                ...
                <div style="background-color: #f6eaf2; padding: 20px; border-bottom: 2px solid #e0e0e0;">
                    ...
                    <div style="text-align: center; margin: 30px 0;">
                        <a href="https://localhost:3000/register/verify-email/${userId}/${token}" style="display: inline-block; padding: 14px 30px; background-color: #581845; color: white; text-decoration: none; border-radius: 5px; font-weight: bold; font-size: 18px; transition: background-color 0.3s ease;">Verify My Email</a>
                    </div>
    ...
    const verifyEmail = async (req, res) => {
        ...
        try {
            ...
            res.redirect("https://localhost:5173/emailVerification?isVerified=true");

        } catch (error) {
            
            res.redirect("https://localhost:5173/emailVerification?isVerified=false");
        }
    };
